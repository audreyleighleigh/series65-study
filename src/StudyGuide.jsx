...
const CONCEPTS = [
...

  {
    ...
    rule: "Under the USA, an investment adviser is anyone who gives advice about **securities** for compensation as a regular business. **Threshold question — wrong subject matter:** advice about commodities, currencies, gold coins, collectibles, or real estate falls outside the definition entirely; the definition only reaches securities. Beyond that, **exclusions are based on who you are or how you operate — never on which asset class you advise on.** The categorical exclusions: **(1) Federal covered advisers** (SEC-registered, so states don't re-capture them). **(2) Banks and savings institutions** (regulated under separate comprehensive regimes). **(3) Broker-dealers** — excluded when advice is incidental to regular business AND no special compensation is charged. Both locks must hold; charging a specific fee breaks the exclusion entirely. **(4) Agents of broker-dealers** — excluded when advice is given within the scope of their employment at the firm. **(5) LATE professionals** — **L**awyers, **A**ccountants, **T**eachers, **E**ngineers — when investment advice is incidental to their primary profession. **(6) Publishers** of *impersonal*, general-circulation financial publications — the key word is *impersonal*; a newsletter offering personalized recommendations to specific subscribers is NOT excluded. **(7) Investment adviser representatives (IARs)** — explicitly a separate regulatory category; the IA definition excludes them by design because they function under a registered IA rather than independently.",
    watch: "The exam will slip in an asset-class-based answer as a fake exclusion — 'a person advising specifically on municipal bonds' or 'a person providing advice on government securities' — hoping you'll assume a narrow focus creates a carve-out. It doesn't; exclusions are entity-based, not asset-based. Separately, the broker-dealer exclusion is a two-lock door — incidental advice AND no special fee — and the exam will satisfy one lock while quietly breaking the other. Two more traps: (a) advice about non-securities (gold, commodities, real estate) feels like investment advice but never triggers the definition in the first place — always check subject matter first; (b) IARs are NOT IAs — these are two separate regulatory categories, and the IA definition explicitly excludes one from the other.",
    quiz: [
      {
      ...
      },
      {
        ...
        answer: 0,
        explain: "Exclusions from the IA definition are based on entity type and structural role, not the asset class being advised on. A person whose practice centers on municipal bond advice is still providing investment advice for compensation — none of the categorical exclusions apply to them. B, C, and D are all genuine exclusions: federal covered advisers are regulated at the federal level; banks operate under separate comprehensive regulation; broker-dealers are excluded when advice is incidental and no special compensation is charged."
      },
      {
