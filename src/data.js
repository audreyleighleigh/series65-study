export const CONCEPTS = [
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        q: "Which of the following sell transactions is NOT subject to the holding period restriction specified in SEC Rule 144?",
        options: [
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        q: "An employee is offered a nonqualified stock option with an exercise price of $20 per share. If the option is exercised when the current market value of the stock is $30, the employee:",
        options: [
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        q: "An investment adviser is researching a company: market price $21/share, most recent EPS $3, quarterly dividend $0.26, and a significant cash position on the balance sheet. This company would probably be attractive to this adviser if his investment style was",
        options: [
          "Growth",
          "Value",
          "Passive",
        ...
        answer: 1,
        explain: "P/E ratio = $21 / $3 = 7, a low P/E — the classic value signal, suggesting the stock is priced cheaply relative to earnings. A significant cash position and a dividend-paying policy also point to a stable, financially strong company, which is squarely value-investor territory (book value and financial statement strength), not the earnings-momentum focus of a growth manager. Nothing in the data suggests accelerating earnings growth, which would be needed to support a growth answer."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        q: "When an investor's original value is subtracted from the ending value, and then the income received over that time period is added to it, and the result is divided by the original cost, the calculation is",
        options: [
...
export const FORMULAS = [
  // ============ OPTIONS ============
  {
    ...
    latex: "\\begin{aligned}\\text{B/E} &= \\text{Strike} + \\text{Premium} \\\\ \\text{Max Gain} &= \\infty \\\\ \\text{Max Loss} &= \\text{Premium paid}\\end{aligned}",
  ...
  },
  {
    ...
    latex: "\\begin{aligned}\\text{B/E} &= \\text{Strike} + \\text{Premium} \\\\ \\text{Max Gain} &= \\text{Premium} \\\\ \\text{Max Loss} &= \\infty \\;\\text{(naked)}\\end{aligned}",
  ...
  },
  {
    ...
    latex: "\\begin{aligned}\\text{B/E} &= \\text{Strike} - \\text{Premium} \\\\ \\text{Max Gain} &= \\text{Strike} - \\text{Premium} \\\\ \\text{Max Loss} &= \\text{Premium paid}\\end{aligned}",
  ...
  },
  {
    ...
    latex: "\\begin{aligned}\\text{B/E} &= \\text{Strike} - \\text{Premium} \\\\ \\text{Max Gain} &= \\text{Premium} \\\\ \\text{Max Loss} &= \\text{Strike} - \\text{Premium}\\end{aligned}",
  ...
  // ============ ORDER TYPES ============
  {
    ...
    latex: "\\begin{aligned}\\textbf{Market:} &\\;\\text{execution guaranteed, price not} \\\\ \\textbf{Limit:} &\\;\\text{price guaranteed, execution not} \\\\ \\textbf{Stop:} &\\;\\rightarrow \\text{market order (nothing guaranteed)} \\\\ \\textbf{Stop-limit:} &\\;\\rightarrow \\text{limit order (nothing guaranteed)}\\end{aligned}",
  ...
  },
  {
    ...
    latex: "\\begin{aligned}\\textbf{SLoBS:} &\\;\\text{Sell Limit / Buy Stop} \\rightarrow \\text{ABOVE market} \\\\ \\textbf{BLiSS:} &\\;\\text{Buy Limit / Sell Stop} \\rightarrow \\text{BELOW market}\\end{aligned}",
  ...
  // ============ TAXES ============
  {
    ...
    latex: "\\text{Cost Basis} = \\text{Purchase Price} + \\text{Commission}",
  ...
  },
  {
    ...
    latex: "\\text{Sales Proceeds} = \\text{Sale Price} - \\text{Commission}",
  ...
  // ============ PORTFOLIO ANALYSIS ============
  {
    ...
    latex: "\\text{Expected Return} = R_f + \\beta \\times (R_m - R_f)",
  ...
  },
  {
    ...
    latex: "\\alpha = R_\\text{actual} - R_\\text{expected (CAPM)}",
  ...
  },
  {
    ...
    latex: "\\text{Sharpe} = \\dfrac{R_\\text{actual} - R_f}{\\sigma}",
  ...
  },
  {
    ...
    latex: "\\text{Total Return} = \\dfrac{\\text{Income} + \\text{Capital Gain/Loss}}{\\text{Original Investment}}",
  ...
  },
  {
    ...
    latex: "\\text{HPR} = \\dfrac{\\text{End Value} - \\text{Original Value} + \\text{Income}}{\\text{Original Cost}}",
  ...
  },
  {
    ...
    latex: "\\text{After-Tax Return} = \\dfrac{\\text{Tax-adjusted gains/losses}}{\\text{Original Investment}}",
  ...
  },
  {
    ...
    latex: "\\text{Real Rate} = R_\\text{nominal} - \\text{Inflation Rate}",
  ...
  },
  {
    ...
    latex: "\\text{Years to Double} = \\dfrac{72}{\\text{Rate }(\\%)}",
  ...
  },
  {
    ...
    latex: "\\text{Rate Needed }(\\%) = \\dfrac{72}{\\text{Years}}",
  ...
  },
  {
    ...
    latex: "\\text{Future Amount} = \\text{Today's Amount} \\times (1 + i)^n",
  ...
  // ============ BOND PRICING & YIELDS ============
  {
    ...
    latex: "\\text{CY} = \\dfrac{\\text{Annual Income}}{\\text{Market Price}}",
  ...
  },
  {
    ...
    latex: "\\text{NY} < \\text{CY} < \\text{YTM} < \\text{YTC}",
  ...
  },
  {
    ...
    latex: "\\text{YTC} < \\text{YTM} < \\text{CY} < \\text{NY}",
  ...
  // ============ CONVERTIBLES & PARITY ============
  {
    ...
    latex: "\\text{Conversion Ratio} = \\dfrac{\\text{Par}}{\\text{Conversion Price}}",
  ...
  },
  {
    ...
    latex: "\\text{Conversion Price} = \\dfrac{\\text{Par}}{\\text{Conversion Ratio}}",
  ...
  },
  {
    ...
    latex: "\\text{Parity Price}_\\text{bond} = \\text{Stock Price} \\times \\text{Conversion Ratio}",
  ...
  },
  {
    ...
    latex: "\\text{Parity Price}_\\text{stock} = \\dfrac{\\text{Bond Price}}{\\text{Conversion Ratio}}",
  ...
  // ============ TAX-EQUIVALENT YIELDS ============
  {
    ...
    latex: "\\text{TEY} = \\dfrac{\\text{Muni Yield}}{1 - \\text{Tax Bracket}}",
  ...
  },
  {
    ...
    latex: "\\text{TFEY} = \\text{Corp Yield} \\times (1 - \\text{Tax Bracket})",
  ...
  // ============ MARGIN ============
  {
    ...
    latex: "\\text{Initial Deposit} = 50\\% \\times \\text{Purchase Price}",
  ...
  },
  {
    ...
    latex: "\\text{Minimum Equity} = \\$2{,}000",
  ...
  },
  {
    ...
    latex: "\\text{Equity} = \\text{LMV} - \\text{Debit Balance}",
  ...
  },
  {
    ...
    latex: "\\text{Equity} = \\text{Credit Balance} - \\text{SMV}",
  ...
  },
  {
    ...
    latex: "\\text{Min Equity} = 25\\% \\times \\text{LMV}",
  ...
  },
  {
    ...
    latex: "\\text{Min Equity} = 30\\% \\times \\text{SMV}",
  ...
  },
  {
    ...
    latex: "\\text{Net Working Capital} = \\text{Current Assets} - \\text{Current Liabilities}",
  ...
  },
  {
    ...
    latex: "\\text{Quick Assets} = \\text{Current Assets} - \\text{Inventory}",
  ...
  },
  {
    ...
    latex: "\\text{Quick Ratio} = \\dfrac{\\text{Current Assets} - \\text{Inventory}}{\\text{Current Liabilities}}",
  ...
  },
  {
    ...
    latex: "\\text{DSCR} = \\dfrac{\\text{Operating Income}}{\\text{Debt Service}}",
  ...
  },
  {
    ...
    latex: "\\text{EPS} = \\dfrac{\\text{Net Earnings}}{\\text{Outstanding Common Shares}}",
  ...
  },
  {
    ...
    latex: "\\text{P/E} = \\dfrac{\\text{Market Price}}{\\text{EPS}}",
  ...
  },
  {
    ...
    latex: "\\text{Dividend Yield} = \\dfrac{\\text{Annual Dividend}}{\\text{Stock Price}}",
  ...
  },
  {
    ...
    latex: "\\text{Payout Ratio} = \\dfrac{\\text{Dividends Paid}}{\\text{Net Earnings}}",
  ...
  },
  {
    ...
    latex: "\\text{Gross Margin} = \\dfrac{\\text{Revenue} - \\text{COGS}}{\\text{Revenue}}",
  ...
  },
  {
    ...
    latex: "\\text{BV/Share} = \\dfrac{\\text{Net Worth} - \\text{Preferred Par}}{\\text{Common Shares}}",
  ...
  // ============ FUND PRICING ============
  {
    ...
    latex: "\\text{NAV} = \\dfrac{\\text{Fund Assets} - \\text{Fund Liabilities}}{\\text{Shares Outstanding}}",
  ...
  },
  {
    ...
    latex: "\\text{POP} = \\dfrac{\\text{NAV}}{1 - \\text{Sales Charge \\%}}",
  ...
  },
  {
    ...
    latex: "\\text{Sales Charge \\%} = \\dfrac{\\text{POP} - \\text{NAV}}{\\text{POP}}",
  ...
  },
  {
    ...
    latex: "\\text{Discount/Premium} = \\dfrac{\\text{Market Price} - \\text{NAV}}{\\text{NAV}}",
